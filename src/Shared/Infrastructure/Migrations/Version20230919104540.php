 ...
 */
final class Version20230919104540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bot_user_token (id VARCHAR(26) NOT NULL, created_at INT NOT NULL, refresh_at INT DEFAULT NULL, token VARCHAR(64) NOT NULL, user_id INT NOT NULL, ip VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
